...
/* Directory separator on target system */
...
/* Define to 1 if you have the `boost_serialization-mt' library
   (-lboost_serialization-mt). */
#define HAVE_LIBBOOST_SERIALIZATION_MT 1
...
/* Name of package */
#define PACKAGE "spyview"

/* Define to the address where bug reports for this package should be sent. */
#define PACKAGE_BUGREPORT "Gary Steele (gsteele@mit.edu)"

/* Define to the full name of this package. */
#define PACKAGE_NAME "spyview"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "spyview 0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "spyview"
...
/* Directory we're ultimately installing to */
#define SPYVIEW_PREFIX "/Users/gsteele"
...
/* True if compiling for win32 */
/* #undef WIN32 */

/* Define to 1 if the X Window System is missing or not being used. */
/* #undef X_DISPLAY_MISSING */

/* Format string for a size_t */
#define _STF "%zd"
